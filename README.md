About link-traits-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/link-traits-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=591&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/link-traits-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `link-traits` can be installed with `conda`:
...
```
mamba install link-traits
```

It is possible to list all of the versions of `link-traits` available on your platform with `conda`:
...
```
mamba search link-traits --channel conda-forge
```
...
mamba repoquery search link-traits --channel conda-forge

# List packages depending on `link-traits`:
mamba repoquery whoneeds link-traits --channel conda-forge

# List dependencies of `link-traits`:
mamba repoquery depends link-traits --channel conda-forge
```
